...
public class Apple extends Item {
    private static final long EXPIRE_DURATION_MILLIS = 10000;
    private static final long STAGE2_MILLIS = 4000;
    private static final long STAGE3_MILLIS = 7000;
    ...
    private static void loadBitmaps(Context context) {
        ...
        bitmap1 = decode(assets, "apple/1.png");
        bitmap2 = decode(assets, "apple/2.png");
        bitmap3 = decode(assets, "apple/3.png");
    }
